...
from server.chat import (chat, summary_chat, knowledge_base_chat, openai_chat,
                         search_engine_chat, agent_chat)
from server.knowledge_base.kb_api import list_kbs, create_kb, delete_kb, list_video_path
...
def create_app():
    ...
    app.get("/knowledge_base/list_video_path",
            tags=["Knowledge Base Management"],
            response_model=ListResponse,
            summary="获取视频路径")(list_video_path)
